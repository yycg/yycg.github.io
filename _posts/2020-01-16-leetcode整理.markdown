...
1. 当前位是0: 2304, 0010~2219, 000~229, 23*10
2. 当前位是1: 2314, 0010~2314, 000~234, 23*10+4+1
3. 当前位大于1: 2344, 0010~2319, 000~239, (23+1)*10
...
#### [leetcode 175: 组合两个表](https://leetcode-cn.com/problems/combine-two-tables/)
